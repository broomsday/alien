...
const CANNED_FOOD_ENERGY_RESTORE: float = 35.0
const ENERGY_DEPLETION_CRITICAL_THRESHOLD: float = 5.0
const ENERGY_DEPLETION_DAMAGE_PER_SECOND: float = 3.0
...
const LOW_ENERGY_PSYCHE_PENALTY_PER_SECOND: float = 0.18
...
const LOW_ENERGY_PSYCHE_THRESHOLD: float = 25.0
